...
const Footer = () => {
  ...
  const MobileFooter = () => (
    <div className="mxy-p bg-verydarkviolet">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="lists flex flex-col text-center gap-y-10">
          <div>
            <p className="text-white font-semibold text-lg mb-4">Features</p>
            <ul className=" flex flex-col text-white font-extralight gap-y-2">
              <li className="hover:cursor-pointer hover:text-cyan">
                Link Shortening
              </li>
              <li className="hover:cursor-pointer hover:text-cyan">
                Branded Links
          ...
          <div>
            ...
            <ul className=" flex flex-col text-white font-extralight gap-y-2">
              <li className="hover:cursor-pointer hover:text-cyan">Blog</li>
              <li className="hover:cursor-pointer hover:text-cyan">
                Developers
              </li>
              <li className="hover:cursor-pointer hover:text-cyan">Support</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className=" flex flex-col text-white font-extralight gap-y-2">
              <li className="hover:cursor-pointer hover:text-cyan">About</li>
              <li className="hover:cursor-pointer hover:text-cyan">Our Team</li>
              <li className="hover:cursor-pointer hover:text-cyan">Careers</li>
              <li className="hover:cursor-pointer hover:text-cyan">Contact</li>
            </ul>
          </div>
        </div>

        <div className="socials flex flex-row items-center justify-center w-1/2 mt-12 ml-4 mb-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-[25px] hover:cursor-pointer fill-white hover:fill-cyan transition-colors duration-300"
          >
  ...
  const DesktopFooter = () => (
    <div className="lg:py-20 lg:px-32 bg-verydarkviolet">
      <div className="flex flex-row justify-between">
        ...
        <div className="lists flex flex-row gap-x-40">
          <div>
            <p className="text-white font-semibold text-lg mb-4">Features</p>
            <ul className=" flex flex-col text-white font-extralight gap-y-2">
              <li className="hover:cursor-pointer hover:text-cyan">
        ...
        <div className="socials flex flex-row justify-center w-[11%]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
